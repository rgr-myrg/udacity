...
import net.usrlib.android.popularmovies.adapter.GridItemAdapter;
...
public class MovieMainActivity extends AppCompatActivity
	...
	private MovieBrowser mMovieBrowser = new MovieBrowser(
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Instantiate Grid View and Adapter
		//createGridView();

		// Instantiate Movie Browser
		createMovieBrowser();
	}
	...
	public boolean onNavigationItemSelected(MenuItem item) {
		...
		switch (id) {
			...
			case R.id.nav_highest_rated:
				browseMoviesSortedBy(MovieVars.HIGHEST_RATED);
				break;
...
//				}
//		);
//Log.d("MAIN", "mToolBarHeight: " + String.valueOf(mToolBarHeight));

		mGridView = (GridView) findViewById(R.id.grid_view);
		//mGridView.setPadding(0,100,0,0);
	...
	private void onMovieFeedLoaded(ArrayList<MovieItemVO> arrayList){
		Log.d("MAIN", ((MovieItemVO) arrayList.get(0)).getImageUrl());
		mGridItemAdapter = new GridItemAdapter(this, arrayList);
