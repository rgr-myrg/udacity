...
public class ChartingActivity extends AppCompatActivity {
	public static final String NAME = ChartingActivity.class.getSimpleName();
...
//	}
	...
	private void fetchHistoricalQuote(final String stockSymbol) {
		Log.d(NAME, "fetchHistoricalQuote stockSymbol: " + stockSymbol);

		try {
			DateVO dateVO = mQuoteRealm.getDateWithSymbolLookup(stockSymbol, this);
			YahooApi.fetchHistoricalQuoteWithDate(stockSymbol, dateVO);
