	...
	public int onRunTask(TaskParams params) {
		...
		if (urlStringBuilder != null) {
			...
			try {
				...
				Log.d("MAIN", "getResponse:" + getResponse);
				...
				try {
					...
					final ArrayList contentVals = Utils.quoteJsonToContentVals(getResponse);
					...
					// Send Broadcast Intent to Widget
					sendSyncBroadcastIntent();
