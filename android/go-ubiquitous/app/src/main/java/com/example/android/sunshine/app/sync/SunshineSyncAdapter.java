...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
	...
	private void notifyWearable() {
		...
		// Connects the client to Google Play services. Blocks until the connection either succeeds
		// or fails, or the timeout is reached. If the client is already connected, this methods
		// returns immediately.
