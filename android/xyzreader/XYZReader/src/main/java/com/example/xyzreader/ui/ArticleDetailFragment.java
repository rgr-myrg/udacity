...
public class ArticleDetailFragment extends Fragment implements
	...
	public static final String NAME = ArticleDetailFragment.class.getSimpleName();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mDrawInsetsFrameLayout = (DrawInsetsFrameLayout) mRootView.findViewById(
				R.id.draw_insets_frame_layout
		);
...
//
	...
	private void bindViews() {
		...
		if (mCursor != null) {
			...
			titleView.setText(NOT_AVAILABLE);
			bylineView.setText(NOT_AVAILABLE);
			bodyView.setText(NOT_AVAILABLE);
		}
	}
